...
## Command line arguments examples
    ...
    $ ./ucli.rb list directories -p aws
    $ ./ucli.rb list snapshots -p aws --all
    $ ./ucli.rb list snapshots -p aws -n my-vps-id
    $ ./ucli.rb create backup --snapshot -p aws -n my-vps-id
